...
func _process(delta: float) -> void:
	...
	# if GlobalVariables.is_camera_follow:
		...
		# elif self.global_position.x - "CharacterBody2D".global_position.x > 960 - character_start_x::
		#	self.global_position.x = "CharacterBody2D".global_position.x + (960 - character_start_x)
